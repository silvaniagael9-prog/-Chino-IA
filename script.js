...
const API_KEY = "sk_92d1097e235a4c259d2e2e934dbab960"; // ← COLOQUE AQUI SUA KEY

const API_URL = "https://api.aimusicapi.ai/v1/suno/create";

/* Função que gera a música com base na letra e estilo */
...
async function gerarMusicaComIA(letra, estilo) {
  ...
  try {
    ...
    if (dados.audio_url) {
      ...
      return dados.audio_url; // URL do áudio gerado
